...
def main():
    ...
    print("  delta_h kernel:            17.8 ms  #2 - serial loops")
    print("  chunk_o kernel:            ~23 ms   #3 - shmem-bound")
    print("  wy_transform (u, w bmm):    4.7 ms")
    print("  forward_sub kernel:         0.65 ms  already efficient")
    print("  --- total CUDA:             ~66 ms")
    print("  FLA Triton reference:       5.2 ms   (12.7x faster)")
    print()
    print("Round-2 fixes:")
    print("  1. Batch the 10-pair intra_solve into a single large bmm")
    print("     (cuBLAS picks better kernels for big batch dim)")
    print("  2. Replace delta_h + chunk_o with Triton kernels")
    print("     (autotuner picks optimal tensor-core tile sizes)")
    print("  3. Consider fusing intra_solve + wy_transform into one kernel")
