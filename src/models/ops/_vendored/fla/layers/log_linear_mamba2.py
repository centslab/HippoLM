...
from src.models.ops._vendored.fla.layers.mamba2 import apply_mask_to_padding_states, causal_conv1d_fn, causal_conv1d_update, is_fast_path_available
from src.models.ops._vendored.fla.layers.utils import get_layer_cache, update_layer_cache
from src.models.ops._vendored.fla.modules.layernorm_gated import RMSNormGated, rmsnorm_fn
from src.models.ops._vendored.fla.ops.log_linear_attn.chunk import LogLinearAttentionState, chunk_log_linear_attn
...
class LogLinearMamba2(nn.Module):
    ...
    def __init__(
        ...
        self.D = nn.Parameter(
            torch.ones(self.intermediate_size if self.D_has_hdim else self.num_heads),
        )
