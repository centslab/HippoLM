...
from src.models.ops._vendored.fla.ops.delta_rule import chunk_delta_rule
from src.models.ops._vendored.fla.ops.gated_delta_rule import chunk_gated_delta_rule
