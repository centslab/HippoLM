...
template <>
class MarlinScalarType<marlin::vllm::kFloat16.id()> {
 public:
  using scalar_t = half;
...
template <>
class MarlinScalarType<marlin::vllm::kBFloat16.id()> {
 public:
...
template <>
class MarlinScalarType<marlin::vllm::kFE4M3fn.id()> {
 public:
...
template <>
class MarlinScalarType<marlin::vllm::kS8.id()> {
 public:
...
template <>
class MarlinScalarType2<half> : public MarlinScalarType<marlin::vllm::kFloat16.id()> {};

template <>
class MarlinScalarType2<nv_bfloat16>
    : public MarlinScalarType<marlin::vllm::kBFloat16.id()> {};

template <>
class MarlinScalarType2<__nv_fp8_e4m3>
    : public MarlinScalarType<marlin::vllm::kFE4M3fn.id()> {};

template <>
class MarlinScalarType2<int8_t> : public MarlinScalarType<marlin::vllm::kS8.id()> {};
