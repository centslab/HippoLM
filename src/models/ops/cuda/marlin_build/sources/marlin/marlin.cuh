#pragma once
  ...
  // <iostream> removed: includes <stringfwd.h> which expects `std::` at
  // file scope. When marlin.cuh is included from inside `namespace marlin
  // { ... }`, the standard library's allocator/basic_string/mbstate_t
  // lookups fail. Not used anywhere in marlin.* so safe to drop.
